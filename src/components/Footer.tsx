...
const Footer: React.FC = () => {
    const { FaFacebook } = icons

    return (
        <footer className='bg-gray-800 px-4 xl:px-0'>
            <div className='max-w-screen-xl py-6 mx-auto'>
                <div className='grid grid-cols-1 gap-6 lg:grid-cols-3'>
                    <div>
                        ...
                        <p className='mt-6 leading-relaxed text-gray-400 md:w-full sm:mx-0 text-left'>
                        ...
                        <ul className='flex justify-center gap-6 mt-4 md:gap-8 sm:justify-start'>
                            <li>
                                <a href='/' rel='noopener noreferrer' target='_blank'>
                                    ...
                                    <FaFacebook className='w-6 h-6 hover:text-blue-500' fill='#8fc2f8' />
                                </a>
                            </li>
                            ...
                            <li>
                                <a href='/' rel='noopener noreferrer' target='_blank'>
                                    ...
                                    <svg className='w-6 h-6 text-blue-300 transition hover:text-blue-500' fill='currentColor'
                    ...
                    <div className='grid grid-cols-1 gap-6 sm:grid-cols-2 lg:col-span-2 md:grid-cols-4 text-center md:text-start'>
                        <div className=''>
                            ...
                            <nav className='mt-8'>
                                <ul className='space-y-4 text-sm'>
                                    <li>
                                        <a href='/'>
                                            <span className='text-white'>Company History</span>
                                        </a>
                                    </li>
                                    ...
                                    <li>
                                        <a href='/'>
                                            <span className='text-white'>Employee Handbook</span>
                                        </a>
                                    </li>
                        ...
                        <div className=''>
                            ...
                            <nav className='mt-8'>
                                <ul className='space-y-4 text-sm'>
                                    ...
                                    <li>
                                        <a className='flex justify-center md:justify-start group gap-1' href='/'>
                                            ...
                                            <span className='relative flex w-2 h-2 -mr-2'>
                                                <span
                                                    className='absolute inline-flex w-full h-full bg-blue-400 rounded-full opacity-75 animate-ping'></span>
                        ...
                        <div className=''>
                            ...
                            <ul className='mt-8 space-y-4 text-sm'>
                                <li>
                                    <a className='flex items-center justify-center md:justify-start gap-1.5 group' href='/'>
                                ...
                                <li className='flex items-start justify-center md:justify-start gap-1.5'>
                                    <svg xmlns='http://www.w3.org/2000/svg' className='w-5 h-5 text-white shrink-0'
                                        fill='none' viewBox='0 0 24 24' stroke='currentColor' strokeWidth='2'>
                                        <path strokeLinecap='round' strokeLinejoin='round'
                ...
                <div className='py-4 border-t border-gray-800'>
                    <div className='flex justify-between items-center'>
                        <p className='text-sm text-gray-500'>
                            &copy; 2024 Zippo Store
                        </p>
                        <span className='text-sm text-gray-400'>
                            <span className='block sm:inline'>All rights reserved.</span>
                            <a className='inline-block' href='/'>
                                <span className='text-blue-300 transition hover:text-blue-300/75'>Terms & Conditions</span>
                            </a>
                            <span>&middot;</span>
                            <a className='inline-block' href='/'>
                                <span className='text-blue-300 transition hover:text-blue-300/75'>Privacy Policy</span>
                            </a>
                        </span>
                    </div>
                </div>
